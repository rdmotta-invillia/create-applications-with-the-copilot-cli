...
Com a issue criada, Joãozinho trabalha com o Copilot CLI standalone de forma interativa para começar a construir a aplicação de calculadora.

### 📖 Teoria: Desenvolvimento Colaborativo com o Copilot CLI

#### Desenvolvimento Interativo com o Copilot CLI

O Copilot CLI standalone (comando `copilot`) oferece uma experiência interativa rica para o desenvolvimento:
...
O Copilot CLI oferece suporte a custom agents que você pode definir no seu repositório:
...
- Eles são ótimos para documentação, infraestrutura, segurança ou tarefas específicas de domínio
...
> [!NOTE]
> Pressione `ctrl+o` para ver a saída dos testes que o Copilot CLI executou para você e que foram aprovados.
